...
#
#                             Remember, funciton_name(variable) _means that we pass in the variable.
...
def lose(nice,mean,name):
    # Substitute the {} wildcards with our variable values.
    print("\nAhhh too bad {}, game over! \nYou now live in a dirty, beat-up \nvan by the river. Your only \nfriends are the cheeto dust on \nyour fingers and a balloon that \nyou named Bob!".format(name))
    # call again function and pass in our variables.
    again(nice,mean,name)
